...
<div class="max-w-7xl mx-auto">
    <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
        <h1 class="text-3xl font-bold mb-4">Temukan Penerbangan Anda</h1>
        <form action="{{ route('flights.search') }}" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
                ...
                <input type="text" name="from" value="{{ request('from') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" placeholder="Kota atau Bandara">
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700">Ke</label>
                <input type="text" name="to" value="{{ request('to') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" placeholder="Kota atau Bandara">
            </div>
            <div>
            ...
            <div>
                ...
                <button type="submit" class="w-full bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700">Cari Penerbangan</button>
            </div>
        </form>
    </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <a href="{{ route('flights.show', $transport['id_transport']) }}" 
                    ...
                    <tr>
                        <td colspan="5" class="px-6 py-4 text-center text-gray-500">
                            Tidak ada penerbangan yang tersedia. Coba kriteria pencarian lain.
                        </td>
                    </tr>
                    @endforelse
                </tbody>
